...
namespace NetApi.Migrations
{
    ...
    [Migration("20200213060934_FilmSchemaUpdate")]
    partial class FilmSchemaUpdate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NetApi.Models.FilmAbstract", b =>
                {
                    b.Property<int>("filmId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("filmId")
            ...
            modelBuilder.Entity("NetApi.Models.Film", b =>
                {
                    b.HasOne("NetApi.Models.FilmAbstract", null)
                        .WithOne("film")
                        .HasForeignKey("NetApi.Models.Film", "filmId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("NetApi.Models.Ticket", b =>
                {
                    b.HasOne("NetApi.Models.Broadcast", "broadcast")
                        .WithMany("tickets")
